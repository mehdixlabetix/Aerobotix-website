...
const Eurobot = () => {
    return (
        <FullScreenSection  backgroundColor="#111512" id='eurobot-section' height={["400px","100vh"]}>
            <HStack spacing={[2,8]} width="100%" height="100%" justifyContent="center" alignItems="center">
                ...
                <VStack spacing={[2,24]}>
                   ...
                   <VStack spacing={8} marginTop={["0%","8%"]} marginBottom={["0%","-7%"]}>
                       ...
                       <a  href='https://www.eurobot.org'><Button marginLeft={['10%','0%']} width={['80%','100%']} colorScheme="whiteAlpha">View More</Button></a></VStack>
                </VStack>
            </HStack>
        </FullScreenSection>
